    ...
    for key in range(order_num):
        ...
        if order[0] == 'I':
            ...
            if order[1] == '-1': 
                ...
                # 이미 상대힙에 의해 삭제된 노드인경우, 상대 힙과 비교해서 자신의 노드들 중에 
				#삭제되지 않은 노드가 나올때까지 계쏙 버리다가 이후 삭제대상노드가 나오면 삭제한다.
                # visit이 False일떄 -> 해당노드가 삭제된상태
                ...
                if min_heap:
                    ...
                    heapq.heappop(min_heap)
								...
								#이미 삭제된 노드인경우 삭제되지 않은 노드가 나올때까지 모두 버린다.
